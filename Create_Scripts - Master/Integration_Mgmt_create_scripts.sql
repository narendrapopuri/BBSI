...
INSERT INTO master_config (id, aplicable_for, json_key, [type]) VALUES(43, 'GET', '$.img_src', 'CLIENT_EMPLOYEES_FILTER');
...
INSERT INTO master_config (id, aplicable_for, json_key, [type]) VALUES(78, 'GET,PUT,POST', '$.img_src', 'EMPLOYEE_INFO');
...
INSERT INTO master_config (id, aplicable_for, json_key, [type]) VALUES(93, 'GET,POST', '$.calculation_result', 'GROSS_TO_NET');
INSERT INTO master_config (id, aplicable_for, json_key, [type]) VALUES(94, 'GET', '$.calculation_result', 'MANUAL_CHECKS');
INSERT INTO master_config (id, aplicable_for, json_key, [type]) VALUES(95, 'GET', '$.img_src', 'CLIENT_EMPLOYEES_FILTER_UQ');
