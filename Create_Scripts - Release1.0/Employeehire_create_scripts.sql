...
create index IDX6yw6ocre0kwyv093fash7tn62 on hire_document (new_hire_id);
create index IDXbkidfe68vf3e15xygvi3cq7o on hire_document (new_hire_id, title);
...
create index IDX82o5khaexisasaqnujffx8yv2 on sign_token_details (sign_type);
